...
from Selenium.Scripts.SDAUA_UOM1 import CustomLogger, SDAUTIL
...
class SDATOM:
    ...
    def check_value(self, locator, value):
        text_data = self.UTIL.retry_find_element(By.XPATH, locator)
        if text_data == value:
            return "OK", text_data
        else:
            return "NOK", text_data
